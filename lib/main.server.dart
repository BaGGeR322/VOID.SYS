...
void main() async {
    ...
    return render(Document(
      ...
      styles: [
        ...
        css('.void-glow').styles(
          raw: {
            'text-shadow':
                '0 0 15px rgba(0,255,65,1), 0 0 30px rgba(0,255,65,0.6), 0 0 60px rgba(0,255,65,0.2)',
          },
        ),
      ],
      head: [
  ...
  var server =
      await shelf_io.serve(handler, InternetAddress.anyIPv4, 8080, shared: true);
